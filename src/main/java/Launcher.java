...
import com.rommelrico.alexa.starcitizenfacts.StarCitizenFactsSpeechlet;
...
public final class Launcher {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        context.addServlet(new ServletHolder(createServlet(new StarCitizenFactsSpeechlet())), "/starcitizenfacts");
        server.start();
        server.join();
    }
